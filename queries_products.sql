...
INSERT INTO products (name, price, can_be_returned) VALUES ('skyhook', 19.99, True);

-- Display only the products that can_be_returned. --
SELECT name, price, can_be_returned FROM products WHERE can_be_returned;
-- or -- 
...
SELECT name, price FROM products WHERE price BETWEEN 25.50 AND 99.99;
...
SELECT name, price FROM products WHERE price < 25.00;
