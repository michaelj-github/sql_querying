...
SELECT app_name, price, rating, reviews FROM analytics WHERE price BETWEEN .1 AND 1 ORDER BY reviews DESC LIMIT 10;
...
SELECT id, app_name, last_updated FROM analytics ORDER BY last_updated LIMIT 1;
...
-- Find the app that has the highest proportion of min_installs to reviews, among apps that have been --
-- installed at least 100,000 times. Display the name of the app along with the number of reviews, the --
-- min_installs, and the proportion. --
SELECT id, app_name, reviews, min_installs, (min_installs / reviews) AS proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;